...
int wtk_mic_check_cfg_init(wtk_mic_check_cfg_t *cfg) {
    ...
    cfg->eng_db_thresh = 6.0;
    cfg->out_range_thresh = 0.1;
...
int wtk_mic_check_cfg_update_local(wtk_mic_check_cfg_t *cfg,
    ...
    wtk_local_cfg_update_cfg_f(lc, cfg, eng_db_thresh, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, out_range_thresh, v);
