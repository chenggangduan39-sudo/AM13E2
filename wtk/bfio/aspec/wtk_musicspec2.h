#ifndef WTK_BFIO_ASPEC_WTK_MUSICSPEC2
#define WTK_BFIO_ASPEC_WTK_MUSICSPEC2
...
// float wtk_musicspec2_flush_spec_k(wtk_musicspec2_t *musicspec2, float **pairs_m, wtk_complex_t *cov, int k, int ang_idx);
