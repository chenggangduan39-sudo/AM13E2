#ifndef WTK_BFIO_MASKDENOISE_CMASK_PSE_WTK_CMASK_BF_PSE_H
#define WTK_BFIO_MASKDENOISE_CMASK_PSE_WTK_CMASK_BF_PSE_H
...
typedef struct wtk_cmask_bf_pse wtk_cmask_bf_pse_t;
typedef enum wtk_cmask_bf_pse_state wtk_cmask_bf_pse_state_e;
typedef enum wtk_cmask_bf_pse_event_type wtk_cmask_bf_pse_event_type_e;
typedef void(*wtk_cmask_bf_pse_notify_f)(void *ths,short *output,int len);
typedef void(*wtk_cmask_bf_pse_notify_f2)(void *ths,float *output,int len);

struct wtk_cmask_bf_pse {
	...
	void *ths;
	wtk_cmask_bf_pse_notify_f notify;

	void *ths2;
	wtk_cmask_bf_pse_notify_f2 notify2;
...
void wtk_cmask_bf_pse_feed(wtk_cmask_bf_pse_t *cmask_bf_pse, short *data, int len, int is_end);
