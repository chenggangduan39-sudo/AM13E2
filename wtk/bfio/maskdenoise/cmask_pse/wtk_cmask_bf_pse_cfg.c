#include "wtk/bfio/maskdenoise/cmask_pse/wtk_cmask_bf_pse_cfg.h"

int wtk_cmask_bf_pse_cfg_init(wtk_cmask_bf_pse_cfg_t *cfg) {
	...
	cfg->q_nf=5;
	cfg->right_nf=14;
	cfg->min_speccrest=5000;
	cfg->envelope_thresh=2000;
...
int wtk_cmask_bf_pse_cfg_clean(wtk_cmask_bf_pse_cfg_t *cfg) {
	if(cfg->mic_channel)
	{
...
int wtk_cmask_bf_pse_cfg_update(wtk_cmask_bf_pse_cfg_t *cfg) {
	int ret;
...
int wtk_cmask_bf_pse_cfg_update2(wtk_cmask_bf_pse_cfg_t *cfg, wtk_source_loader_t *sl) {
	int ret;
...
int wtk_cmask_bf_pse_cfg_update_local(wtk_cmask_bf_pse_cfg_t *cfg, wtk_local_cfg_t *m) {
	wtk_string_t *v;
	wtk_local_cfg_t *lc;
	int ret;
	wtk_array_t *a;
...
wtk_cmask_bf_pse_cfg_t* wtk_cmask_bf_pse_cfg_new(char *fn)
{
	wtk_main_cfg_t *main_cfg;
	wtk_cmask_bf_pse_cfg_t *cfg;

	main_cfg=wtk_main_cfg_new_type(wtk_cmask_bf_pse_cfg,fn);
	if(!main_cfg)
	{
		return NULL;
	}
	cfg=(wtk_cmask_bf_pse_cfg_t*)main_cfg->cfg;
	cfg->main_cfg = main_cfg;
	return cfg;
}

void wtk_cmask_bf_pse_cfg_delete(wtk_cmask_bf_pse_cfg_t *cfg)
{
	wtk_main_cfg_delete(cfg->main_cfg);
}

wtk_cmask_bf_pse_cfg_t* wtk_cmask_bf_pse_cfg_new_bin(char *fn)
{
	wtk_mbin_cfg_t *mbin_cfg;
	wtk_cmask_bf_pse_cfg_t *cfg;

	mbin_cfg=wtk_mbin_cfg_new_type(wtk_cmask_bf_pse_cfg,fn,"./cfg");
	if(!mbin_cfg)
	{
		return NULL;
	}
	cfg=(wtk_cmask_bf_pse_cfg_t*)mbin_cfg->cfg;
	cfg->mbin_cfg=mbin_cfg;
	return cfg;
}

void wtk_cmask_bf_pse_cfg_delete_bin(wtk_cmask_bf_pse_cfg_t *cfg)
{
