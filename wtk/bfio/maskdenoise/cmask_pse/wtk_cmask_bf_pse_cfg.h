#ifndef WTK_BFIO_MASKDENOISE_CMASK_PSE_WTK_CMASK_BF_PSE_CFG_H
#define WTK_BFIO_MASKDENOISE_CMASK_PSE_WTK_CMASK_BF_PSE_CFG_H
...
typedef struct wtk_cmask_bf_pse_cfg wtk_cmask_bf_pse_cfg_t;

struct wtk_cmask_bf_pse_cfg {
...
int wtk_cmask_bf_pse_cfg_update_local(wtk_cmask_bf_pse_cfg_t *cfg, wtk_local_cfg_t *lc);
