#ifndef WTK_BFIO_QFORM_BEAMNET_WTK_BEAMNET2_CFG_H
#define WTK_BFIO_QFORM_BEAMNET_WTK_BEAMNET2_CFG_H
...
typedef struct wtk_beamnet2_cfg wtk_beamnet2_cfg_t;

struct wtk_beamnet2_cfg {
...
int wtk_beamnet2_cfg_update_local(wtk_beamnet2_cfg_t *cfg, wtk_local_cfg_t *lc);
