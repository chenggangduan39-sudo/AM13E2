#ifndef WTK_BFIO_QFORM_BEAMNET_WTK_BEAMNET3_CFG_H
#define WTK_BFIO_QFORM_BEAMNET_WTK_BEAMNET3_CFG_H
...
typedef struct wtk_beamnet3_cfg wtk_beamnet3_cfg_t;

struct wtk_beamnet3_cfg {
    ...
    float *query_region;
    float *target_theta;
    float horizon_resolution;
    float horizon_resolution_arc;
    int total_regions;
    ...
    unsigned int use_raw_mask:1;
    unsigned int is_linear_array:1;
    unsigned int need_theta_calibration:1;
};
...
int wtk_beamnet3_cfg_update_local(wtk_beamnet3_cfg_t *cfg, wtk_local_cfg_t *lc);
