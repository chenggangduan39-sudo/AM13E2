#ifndef WTK_BFIO_QFORM_WTK_qform3_CFG
#define WTK_BFIO_QFORM_WTK_qform3_CFG
...
extern "C" {
#endif
typedef struct wtk_qform3_cfg wtk_qform3_cfg_t;
struct wtk_qform3_cfg
{
