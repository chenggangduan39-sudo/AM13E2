...
wtk_rtjoin2_t *wtk_rtjoin2_new(wtk_rtjoin2_cfg_t *cfg) {
    ...
    rtjoin2->limiter = NULL;
    if (cfg->use_limiter) {
        rtjoin2->limiter = wtk_limiter_new(&(cfg->limiter));
    }
...
void wtk_rtjoin2_delete(wtk_rtjoin2_t *rtjoin2) {
    ...
    if (rtjoin2->limiter) {
        wtk_limiter_delete(rtjoin2->limiter);
    }
    if (rtjoin2->vdr) {
...
void wtk_rtjoin2_reset(wtk_rtjoin2_t *rtjoin2) {
    ...
    if (rtjoin2->limiter) {
        wtk_limiter_reset(rtjoin2->limiter);
    }
    ...
    while (length >= slid_len) {
        ...
        if (rtjoin2->cfg->use_mul_out) {
            ...
            if (rtjoin2->cfg->use_limiter) {
                wtk_limiter_feed(rtjoin2->limiter, out, fsize);
