...
int wtk_qmmse_cfg_init(wtk_qmmse_cfg_t *cfg)
{
    ...
    cfg->agc_entropy_thresh=-1;
    cfg->echo_agc_entropy_thresh=-1;
    cfg->agc_entropy_cnt=20;
    cfg->echo_agc_entropy_cnt=20;
    cfg->b_agc_scale=1.0;
...
int wtk_qmmse_cfg_update_local(wtk_qmmse_cfg_t *cfg,wtk_local_cfg_t *lc)
{
    ...
    wtk_local_cfg_update_cfg_f(lc,cfg,agc_entropy_thresh,v);
    wtk_local_cfg_update_cfg_f(lc,cfg,echo_agc_entropy_thresh,v);
    wtk_local_cfg_update_cfg_i(lc,cfg,agc_entropy_cnt,v);
    wtk_local_cfg_update_cfg_i(lc,cfg,echo_agc_entropy_cnt,v);
    ...
    wtk_local_cfg_update_cfg_b(lc,cfg,use_pre_loudness,v);
    if (cfg->agc_level<1)
    {
        cfg->agc_level=1;
    }
