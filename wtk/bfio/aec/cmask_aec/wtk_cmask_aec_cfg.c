...
void wtk_cmask_aec_cfg_get_mic_theta(wtk_cmask_aec_cfg_t *cfg)
{
	int i;
	float x, y;
	float angle_rad;
...
int wtk_cmask_aec_cfg_update(wtk_cmask_aec_cfg_t *cfg) {
	...
	wtk_cmask_aec_cfg_get_mic_theta(cfg);
...
int wtk_cmask_aec_cfg_update_local(wtk_cmask_aec_cfg_t *cfg, wtk_local_cfg_t *m) {
	wtk_string_t *v;
	wtk_local_cfg_t *lc;
	int ret;
	wtk_array_t *a;
...
wtk_cmask_aec_cfg_t* wtk_cmask_aec_cfg_new(char *fn)
{
	...
	main_cfg=wtk_main_cfg_new_type(wtk_cmask_aec_cfg,fn);
	if(!main_cfg)
	{
		return NULL;
	}
	cfg=(wtk_cmask_aec_cfg_t*)main_cfg->cfg;
...
wtk_cmask_aec_cfg_t* wtk_cmask_aec_cfg_new_bin(char *fn)
{
	...
	mbin_cfg=wtk_mbin_cfg_new_type(wtk_cmask_aec_cfg,fn,"./cfg");
	if(!mbin_cfg)
	{
		return NULL;
	}
	cfg=(wtk_cmask_aec_cfg_t*)mbin_cfg->cfg;
