...
typedef void (*wtk_mask_bf_net_notify_f2)(void *ths, short *output,
                                          short *output2, int len);
typedef void (*wtk_mask_bf_net_notify_ssl_f)(void *ths, float ts, float te,
...
struct wtk_mask_bf_net {
    ...
    void *ths2;
    wtk_mask_bf_net_notify_f2 notify2;
    void *ssl_ths;
    wtk_mask_bf_net_notify_ssl_f notify_ssl;
...
void wtk_mask_bf_net_set_agc2enable(wtk_mask_bf_net_t *mask_bf_net, int enable);
