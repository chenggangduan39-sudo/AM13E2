...
int wtk_mask_bf_net_cfg_init(wtk_mask_bf_net_cfg_t *cfg) {
    ...
    wtk_kalman_cfg_init(&(cfg->echo_kalman));
    ...
    cfg->trick_clip_s = 150;
    cfg->trick_clip_e = 3500;
    cfg->trick_cnt = 5;
    cfg->trick_thresh = 1;
    cfg->trick_thresh_e = 1;
    cfg->trick_scale = 0.01;

    cfg->trick1_clip_s = 150;
    cfg->trick1_clip_s_e = 150;
    cfg->trick1_clip_e = 3500;
    cfg->trick1_clip_e_e = 3500;
    cfg->trick1_cnt = 5;
    cfg->trick1_cnt_e = 5;
    cfg->trick1_thresh = 1e-3;
    cfg->trick1_thresh_e = 1e-3;
    cfg->trick1_scale = 0.01;
    cfg->trick1_scale_e = 0.01;

    cfg->reset_model_cnt = -1;
    ...
    cfg->use_two_pass = 0;
    cfg->use_post_mask = 0;
    cfg->use_raw_highpass = 0;
    cfg->use_maskssl2 = 0;
    cfg->use_denoise_agc = 0;
    cfg->use_echo_filter_model = 0;
    cfg->use_s1_mask_to_s2 = 0;
    cfg->use_asr_3A_out = 0;
...
int wtk_mask_bf_net_cfg_clean(wtk_mask_bf_net_cfg_t *cfg) {
    ...
    wtk_kalman_cfg_clean(&(cfg->echo_kalman));
...
int wtk_mask_bf_net_cfg_update(wtk_mask_bf_net_cfg_t *cfg) {
    ...
    if (cfg->use_kalman) {
        cfg->echo_kalman.nmicchannel = cfg->nmicchannel;
        ret = wtk_kalman_cfg_update(&(cfg->echo_kalman));
    }
    ...
    if (cfg->bf.nmic > cfg->nbfchannel) {
        cfg->bf.nmic = cfg->nbfchannel;
    } else {
        wtk_bf_cfg_set_channel(&(cfg->bf), cfg->nbfchannel);
    }
    ...
    cfg->trick_clip_s = (cfg->trick_clip_s * 1.0 * cfg->wins) / cfg->rate;
    cfg->trick_clip_e = (cfg->trick_clip_e * 1.0 * cfg->wins) / cfg->rate;
    cfg->trick1_clip_s = (cfg->trick1_clip_s * 1.0 * cfg->wins) / cfg->rate;
    cfg->trick1_clip_s_e = (cfg->trick1_clip_s_e * 1.0 * cfg->wins) / cfg->rate;
    cfg->trick1_clip_e = (cfg->trick1_clip_e * 1.0 * cfg->wins) / cfg->rate;
    cfg->trick1_clip_e_e = (cfg->trick1_clip_e_e * 1.0 * cfg->wins) / cfg->rate;
...
int wtk_mask_bf_net_cfg_update_local(wtk_mask_bf_net_cfg_t *cfg,
    ...
    wtk_local_cfg_update_cfg_f(lc, cfg, raw_scale, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, limiter_thresh, v);

    wtk_local_cfg_update_cfg_i(lc, cfg, trick_clip_s, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick_clip_e, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick_cnt, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick_thresh, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick_thresh_e, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick_scale, v);

    wtk_local_cfg_update_cfg_i(lc, cfg, trick1_clip_s, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick1_clip_s_e, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick1_clip_e, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick1_clip_e_e, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick1_cnt, v);
    wtk_local_cfg_update_cfg_i(lc, cfg, trick1_cnt_e, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick1_thresh, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick1_thresh_e, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick1_scale, v);
    wtk_local_cfg_update_cfg_f(lc, cfg, trick1_scale_e, v);

    wtk_local_cfg_update_cfg_i(lc, cfg, reset_model_cnt, v);
    ...
    wtk_local_cfg_update_cfg_b(lc, cfg, use_trick1, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_trick, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_only_aec, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_two_pass, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_post_mask, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_raw_highpass, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_maskssl2, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_denoise_agc, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_echo_filter_model, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_s1_mask_to_s2, v);
    wtk_local_cfg_update_cfg_b(lc, cfg, use_asr_3A_out, v);
    ...
    if (lc) {
        ret = wtk_kalman_cfg_update_local(&(cfg->echo_kalman), lc);
        if (ret != 0) {
            goto end;
        }
    }
