...
#include "wtk/bfio/afilter/wtk_kalman.h"
...
struct wtk_mask_bf_net_cfg {
    ...
    int trick1_cnt_e;
    float trick1_thresh;
    float trick1_thresh_e;
    float trick1_scale;
    float trick1_scale_e;
    ...
    unsigned use_trick1 : 1;
    unsigned use_trick : 1;
    unsigned use_only_aec : 1;
    unsigned use_two_pass : 1;
    unsigned use_post_mask : 1;
    unsigned use_raw_highpass : 1;
    unsigned use_maskssl2 : 1;
    unsigned use_denoise_agc : 1;
    unsigned use_echo_filter_model : 1;
    unsigned use_s1_mask_to_s2 : 1;
    unsigned use_asr_3A_out : 1;
};
