...
#include "wtk/bfio/ahs/kmdl/denoise.h"
#include "wtk/bfio/ahs/kmdl/backbone.h"
#include "wtk/bfio/ahs/kmdl/YIN.h"
...
struct qtk_ahs {
    ...
    SignalState *mic_state;
    SignalState *kalman_out_state;
    SignalState *echo_est_state;
    RNNState *rnn_state;
    PitchState *pst;
    unsigned is_loop:1;
};
