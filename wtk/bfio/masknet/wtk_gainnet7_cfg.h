#ifndef WTK_BFIO_MASKNET_WTK_GAINNET7_CFG
#define WTK_BFIO_MASKNET_WTK_GAINNET7_CFG
...
extern "C" {
#endif
typedef struct wtk_gainnet7_cfg wtk_gainnet7_cfg_t;

//denoise

struct wtk_gainnet7_cfg
{
    char *model_fn;
