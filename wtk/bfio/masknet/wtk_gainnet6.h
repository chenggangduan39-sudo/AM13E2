#ifndef WTK_BFIO_MASKNET_WTK_GAINNET6
#define WTK_BFIO_MASKNET_WTK_GAINNET6
#include "wtk_gainnet6_cfg.h"
#include "wtk/core/wtk_complex.h"
#ifdef __cplusplus
extern "C" {
#endif
typedef void (*wtk_gainnet6_notify_f)(void *ths, float *gain, int len, int is_end);
typedef void (*wtk_gainnet6_notify_f2)(void *ths, float *gain, int len, int is_end);
typedef struct wtk_gainnet6 wtk_gainnet6_t;
...
struct wtk_gainnet6
{
    ...
    wtk_gainnet6_notify_f notify;
    void *ths;

    wtk_gainnet6_notify_f2 notify2;
    void *ths2;
...
void wtk_gainnet6_set_notify2(wtk_gainnet6_t *masknet, void *ths, wtk_gainnet6_notify_f2 notify2);
#ifdef __cplusplus
};
#endif
#endif