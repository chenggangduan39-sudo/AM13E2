#ifndef WTK_BFIO_SIGNAL_COMPRESS_CFG
#define WTK_BFIO_SIGNAL_COMPRESS_CFG
...
extern "C" {
#endif
typedef struct qtk_signal_compress_cfg qtk_signal_compress_cfg_t;
struct qtk_signal_compress_cfg
{
    wtk_main_cfg_t *main_cfg;
    wtk_mbin_cfg_t *mbin_cfg;

	qtk_nnrt_cfg_t encoder;
	qtk_nnrt_cfg_t rvq_encoder;
};
...
int qtk_signal_compress_cfg_update_local(qtk_signal_compress_cfg_t *cfg,wtk_local_cfg_t *lc);
