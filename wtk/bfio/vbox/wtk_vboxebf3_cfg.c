...
void wtk_vboxebf3_cfg_update_comp_filter(wtk_vboxebf3_cfg_t *cfg)
{
	int i, k;
	int nbin = cfg->wins/2+1;
	cfg->comp_filter = wtk_complex_new_p2(cfg->nmicchannel, nbin);
...
int wtk_vboxebf3_cfg_update(wtk_vboxebf3_cfg_t *cfg) {
	...
	if(cfg->compsamp){
		wtk_vboxebf3_cfg_update_comp_filter(cfg);
	}
