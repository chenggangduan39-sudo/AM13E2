...
Not needing to deal with qdm_kiss_fft_alloc and a config 
...
/*forward complex FFT */
void KISS_FFT_API kfc_fft(int nfft, const qdm_kiss_fft_cpx * fin,qdm_kiss_fft_cpx * fout);
/*reverse complex FFT */
void KISS_FFT_API kfc_ifft(int nfft, const qdm_kiss_fft_cpx * fin,qdm_kiss_fft_cpx * fout);
