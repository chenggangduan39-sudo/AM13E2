#ifndef QBL_NN_QBL_NN_ABS_H
#define QBL_NN_QBL_NN_ABS_H
#pragma once
...
static void nn_abs_f32_(float *x, float *y, uint32_t nelem) {
...
qtk_maybe_unused static void vm_Abs_(qtk_nn_vm_t *nv, uint8_t **instructions) {
...
qtk_maybe_unused static int vm_Abs_infer_shape_(qtk_nn_vm_t *nv,
