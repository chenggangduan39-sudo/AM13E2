#ifndef EEF401F6_5C10_452C_8D45_8060CAB4854D
#define EEF401F6_5C10_452C_8D45_8060CAB4854D

#include "qtk/core/qtk_binary.h"
#include "qtk/nn/qtk_nn_utils.h"
#include "qtk/nn/vm/qtk_nn_vm.h"

static void nn_cos_f32_(float *x, float *y, uint32_t nelem) {
    for (uint32_t i = 0; i < nelem; i++) {
        y[i] = cosf(x[i]);
    }
}

qtk_maybe_unused static void vm_Cos_(qtk_nn_vm_t *nv, uint8_t **instructions) {
...
#endif /* EEF401F6_5C10_452C_8D45_8060CAB4854D */
