#ifndef QBL_NN_QBL_NN_REDUCE_MEAN_H
#define QBL_NN_QBL_NN_REDUCE_MEAN_H
#pragma once
...
qtk_maybe_unused static int vm_ReduceMean_infer_shape_(qtk_nn_vm_t *nv,
...
qtk_maybe_unused static void vm_ReduceMean_(qtk_nn_vm_t *nv,
                                            uint8_t **instructions) {
