#ifndef QBL_NN_QBL_NN_SQRT_H
#define QBL_NN_QBL_NN_SQRT_H
#pragma once
...
qtk_maybe_unused static int vm_Sqrt_infer_shape_(qtk_nn_vm_t *nv,
...
qtk_maybe_unused static void vm_Sqrt_(qtk_nn_vm_t *nv, uint8_t **instructions) {
    uint16_t x = qtk_littleEndian_uint16_from_bin(*instructions),
             y = qtk_littleEndian_uint16_from_bin(*instructions + 2);
    ...
    qtk_vector_sqrt_elewise(X.f32, Y.f32, nelem);
