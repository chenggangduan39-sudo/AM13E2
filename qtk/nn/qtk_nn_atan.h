#ifndef E931C4FA_542B_0CDF_14AF_7B9F601070E3
#define E931C4FA_542B_0CDF_14AF_7B9F601070E3

#include "qtk/core/qtk_binary.h"
#include "qtk/nn/qtk_nn_utils.h"
#include "qtk/nn/vm/qtk_nn_vm.h"

static void nn_atan_f32_(float *x, float *y, uint32_t nelem) {
    for (uint32_t i = 0; i < nelem; i++) {
        y[i] = atanf(x[i]);
    }
}

qtk_maybe_unused static void vm_Atan_(qtk_nn_vm_t *nv, uint8_t **instructions) {
    ...
    case QBL_NN_VM_TENSOR_ELEM_F32:
        nn_atan_f32_(X.f32, Y.f32, nelem);
        break;
    default:
        qtk_assert(0);
    }
...
#endif /* E931C4FA_542B_0CDF_14AF_7B9F601070E3 */
