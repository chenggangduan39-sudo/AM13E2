#ifndef AF0FAC7C_9840_4321_A090_4558B876C17D
#define AF0FAC7C_9840_4321_A090_4558B876C17D
#pragma once
...
qtk_maybe_unused static int vm_Greater_infer_shape_(qtk_nn_vm_t *nv,
...
qtk_maybe_unused static void vm_Greater_(qtk_nn_vm_t *nv,
                                         uint8_t **instructions) {
    uint16_t a = qtk_littleEndian_uint16_from_bin(*instructions),
             b = qtk_littleEndian_uint16_from_bin(*instructions + 2),
             y = qtk_littleEndian_uint16_from_bin(*instructions + 4);
...
#endif
#endif /* AF0FAC7C_9840_4321_A090_4558B876C17D */
