...
int qtk_stitch_run_cfg_init(qtk_stitch_run_cfg_t *cfg)
{
    ...
    cfg->use_humanseg = 0;
    cfg->use_draw_seam_lines = 0;
    cfg->use_limit_region = 0;
    cfg->seammask_to_standard = 10;
    qtk_stitch_humanseg_cfg_init(&cfg->humanseg_cfg);
    cfg->image_direction = 0;
    cfg->images_arrangement = 0;
    return 0;
}
...
int qtk_stitch_run_cfg_update_local(qtk_stitch_run_cfg_t *cfg,wtk_local_cfg_t *main_lc)
{
    ...
    wtk_local_cfg_update_cfg_i(main_lc,cfg,use_draw_seam_lines,v);
    wtk_local_cfg_update_cfg_i(main_lc,cfg,use_limit_region,v);
    wtk_local_cfg_update_cfg_f(main_lc,cfg,seammask_threshold,v);
    wtk_local_cfg_update_cfg_i(main_lc,cfg,seammask_to_standard,v);
    wtk_local_cfg_update_cfg_i(main_lc,cfg,images_arrangement,v);
    wtk_local_cfg_update_cfg_i(main_lc,cfg,image_direction,v);
