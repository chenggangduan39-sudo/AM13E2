 ...
 */
typedef double (*kmeans_distance_method)(void *upval, const Pointer a,
                                         const Pointer b);
 ...
 * allocated)
 */
typedef void (*kmeans_centroid_method)(void *upval, const Pointer *objs,
                                       const int *clusters, size_t num_objs,
