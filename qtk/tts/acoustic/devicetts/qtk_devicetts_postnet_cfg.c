...
{
    memset(cfg, 0, sizeof(qtk_devicetts_postnet_cfg_t));
    return 0;
}
...
int qtk_devicetts_postnet_cfg_update_local(qtk_devicetts_postnet_cfg_t *cfg,wtk_local_cfg_t *main_lc)
{
    int ret = 0;
    wtk_string_t *v = NULL;

    wtk_local_cfg_update_cfg_b(main_lc,cfg,useblk,v);
