...
{
    memset(cfg, 0, sizeof(qtk_durian_duration_predictor_cfg_t));
...
int qtk_durian_duration_predictor_cfg_update_local(qtk_durian_duration_predictor_cfg_t *cfg,wtk_local_cfg_t *main_lc)
{
    wtk_string_t *v = NULL;
