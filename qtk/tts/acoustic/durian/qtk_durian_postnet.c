...
{
    qtk_durian_postnet_t *postnet = NULL;
    int n = cfg->convrbn,i = 0;
    int *dim = NULL;
    
    postnet = wtk_calloc(1, sizeof(qtk_durian_postnet_t));
    postnet->cfg = cfg;
    postnet->heap = heap;
...
int qtk_durian_postnet_delete(qtk_durian_postnet_t *postnet)
{
...
wtk_matf_t* qtk_durian_postnet_process(qtk_durian_postnet_t *postnet,wtk_matf_t *in)
{
