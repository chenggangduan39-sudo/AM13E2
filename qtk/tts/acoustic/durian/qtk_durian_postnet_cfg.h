#ifndef __QTK_DURIAN_POSTNET_CFG_H__
#define __QTK_DURIAN_POSTNET_CFG_H__
...
typedef struct qtk_durian_postnet_cfg{
    int convrbn;
...
int qtk_durian_postnet_cfg_update_local(qtk_durian_postnet_cfg_t *cfg,wtk_local_cfg_t *lc);
