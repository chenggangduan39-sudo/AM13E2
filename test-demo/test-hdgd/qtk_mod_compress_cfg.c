...
#endif
    wtk_string_set(&cfg->compress_fn, 0, 0);
    wtk_string_set(&cfg->decompress_fn, 0, 0);
...
int qtk_mod_compress_cfg_update_local(qtk_mod_compress_cfg_t *cfg,wtk_local_cfg_t *main)
{
    wtk_local_cfg_t *lc;
    wtk_string_t *v;
    wtk_local_cfg_update_cfg_string_v(main, cfg, compress_fn, v);
    wtk_local_cfg_update_cfg_string_v(main, cfg, decompress_fn, v);
