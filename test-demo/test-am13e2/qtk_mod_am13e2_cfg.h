...
#include "sdk/qtk_uart_client_cfg.h"
...
typedef struct qtk_mod_am13e2_cfg{
	...
	wtk_string_t gainnetbf2_fn;
	wtk_string_t gainnetbf3_fn;
	wtk_string_t gainnetbf4_fn;
	...
	qtk_gainnetbf_cfg_t *gainnetbf2_cfg;
	qtk_gainnetbf_cfg_t *gainnetbf3_cfg;
	qtk_gainnetbf_cfg_t *gainnetbf4_cfg;

	wtk_mic_check_cfg_t *mic_check_rcd_cfg;
	wtk_mic_check_cfg_t *mic_check_play_cfg;
	qtk_uart_client_cfg_t *uart_cfg;
	...
	float echo_shift;
	float in_inputtolineout_shift;
	float in_inputtospeaker_shift;
	...
	unsigned int volum_output_mute:1;
	unsigned int volum_input_mute:1;

	unsigned int use_onlylineout:1;
	unsigned int use_onlylineinspk:1;
	unsigned int use_onlylineinout:1;
