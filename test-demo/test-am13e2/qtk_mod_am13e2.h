...
typedef enum{
	...
	qtk_mod_am13e2_DATA_UAC_TOSPK,
	qtk_mod_am13e2_DATA_UAC_TOLINEOUT,
...
typedef struct qtk_mod_am13e2{
	...
	qtk_gainnetbf_t *gainnetbf_3ch;
	qtk_gainnetbf_t *gainnetbf2_3ch;
	qtk_gainnetbf_t *gainnetbf3_3ch;
	qtk_gainnetbf_t *gainnetbf4_3ch;

	qtk_gainnetbf_t *gainnetbf_4ch;
	qtk_gainnetbf_t *gainnetbf2_4ch;

	qtk_gainnetbf_t *gainnetbf_6ch;
	qtk_gainnetbf_t *gainnetbf2_6ch;
	...
	qtk_dev_event_t *dev_event;

	qtk_uart_client_t *uart;
	...
	int mic_channel;
	int speak_check_result;
	int mic_check_result;
