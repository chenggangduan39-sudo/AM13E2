...
int qtk_recorder_cfg_update_local(qtk_recorder_cfg_t *cfg,wtk_local_cfg_t *lc)
{
	...
	wtk_local_cfg_update_cfg_i(lc,cfg,max_read_fail_times,v);
...
{
	cfg->buf_size=cfg->buf_time*cfg->sample_rate*cfg->bytes_per_sample*cfg->channel/1000;
	return 0;
}
