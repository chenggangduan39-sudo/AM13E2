...
int qtk_mod_am60_cfg_init(qtk_mod_am60_cfg_t *cfg)
{
#ifndef __ANDROID__
    qtk_record_cfg_init(&cfg->micrcd);
    qtk_record_cfg_init(&cfg->spkrcd);
...
int qtk_mod_am60_cfg_clean(qtk_mod_am60_cfg_t *cfg)
{
#ifndef __ANDROID__
    qtk_record_cfg_clean(&cfg->micrcd);
    qtk_record_cfg_clean(&cfg->spkrcd);
...
int qtk_mod_am60_cfg_update_local(qtk_mod_am60_cfg_t *cfg,wtk_local_cfg_t *main)
{
    wtk_local_cfg_t *lc;
    wtk_string_t *v;
...
#ifndef __ANDROID__
    lc = wtk_local_cfg_find_lc_s(main, "micrcd");
    if(lc){
        qtk_record_cfg_update_local(&cfg->micrcd, lc);
    }
    lc = wtk_local_cfg_find_lc_s(main, "spkrcd");
    if(lc){
        qtk_record_cfg_update_local(&cfg->spkrcd, lc);
    }
...
int qtk_mod_am60_cfg_update(qtk_mod_am60_cfg_t *cfg)
{
#ifndef __ANDROID__
    qtk_record_cfg_update(&cfg->micrcd);
    qtk_record_cfg_update(&cfg->spkrcd);
