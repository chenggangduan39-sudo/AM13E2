...
/* paraeters: <peer address> <PIN> */
#define P2P_EVENT_PROV_DISC_SHOW_PIN "P2P-PROV-DISC-SHOW-PIN "
/* paraeters: <peer address> */
#define P2P_EVENT_PROV_DISC_ENTER_PIN "P2P-PROV-DISC-ENTER-PIN "
/* paraeters: <peer address> */
#define P2P_EVENT_PROV_DISC_PBC_REQ "P2P-PROV-DISC-PBC-REQ "
/* paraeters: <peer address> */
#define P2P_EVENT_PROV_DISC_PBC_RESP "P2P-PROV-DISC-PBC-RESP "
/* paraeters: <peer address> <status> */
#define P2P_EVENT_PROV_DISC_FAILURE "P2P-PROV-DISC-FAILURE"
/* paraeters: <freq> <src addr> <dialog token> <update indicator> <TLVs> */
#define P2P_EVENT_SERV_DISC_REQ "P2P-SERV-DISC-REQ "
/* paraeters: <src addr> <update indicator> <TLVs> */
...
/* paraeters: <PMF enabled> <timeout in ms> <Session Information URL> */
...
/* Credential block added; paraeters: <id> */
#define CRED_ADDED "CRED-ADDED "
/* Credential block modified; paraeters: <id> <field> */
#define CRED_MODIFIED "CRED-MODIFIED "
/* Credential block removed; paraeters: <id> */
#define CRED_REMOVED "CRED-REMOVED "

#define GAS_RESPONSE_INFO "GAS-RESPONSE-INFO "
/* paraeters: <addr> <dialog_token> <freq> */
#define GAS_QUERY_START "GAS-QUERY-START "
/* paraeters: <addr> <dialog_token> <freq> <status_code> <result> */
 ...
 * messages may be received if wpa_ctrl_request() is called at the sae time as
 * wpa_supplicant/hostapd is sending such a message. This can happen only if
 * the progra has used wpa_ctrl_attach() to register itself as a monitor for
 * event messages. Alternatively to msg_cb, progras can register two control
