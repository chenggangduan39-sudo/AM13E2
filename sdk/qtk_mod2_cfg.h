#ifndef __SDK_MOD2_CFG_H__
#define __SDK_MOD2_CFG_H__
...
int qtk_mod2_cfg_init(qtk_mod2_cfg_t *cfg);
int qtk_mod2_cfg_clean(qtk_mod2_cfg_t *cfg);
int qtk_mod2_cfg_update_local(qtk_mod2_cfg_t *cfg,wtk_local_cfg_t *main);
int qtk_mod2_cfg_update(qtk_mod2_cfg_t *cfg);
#ifdef __cplusplus
};
#endif
#endif
