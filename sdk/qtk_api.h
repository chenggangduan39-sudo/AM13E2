...
DLL_API int qtk_engine_feed2(qtk_engine_t *e, char *input, int in_bytes, char *output, int *out_bytes, qtk_feed_type_t is_end);
...
typedef struct qtk_module_avspeech qtk_module_avspeech_t;
DLL_API qtk_module_avspeech_t* qtk_module_avspeech_new(qtk_session_t *session, char *params);
DLL_API int qtk_module_avspeech_delete(qtk_module_avspeech_t *mv);
DLL_API int qtk_module_avspeech_start(qtk_module_avspeech_t *mv);
DLL_API int qtk_module_avspeech_stop(qtk_module_avspeech_t *mv);
DLL_API int qtk_module_avspeech_feed_audio(qtk_module_avspeech_t *mv, char *data, int bytes);
DLL_API int qtk_module_avspeech_feed_image(qtk_module_avspeech_t *mv, char *data);
DLL_API int qtk_module_avspeech_set(qtk_module_avspeech_t *mv, char *params);
DLL_API int qtk_module_avspeech_set_notify(qtk_module_avspeech_t *mv,void *user_data,qtk_engine_notify_f notify);
