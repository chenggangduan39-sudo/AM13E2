#ifndef __SDK_MOD_ULT_CFG_H__
#define __SDK_MOD_ULT_CFG_H__
...
typedef struct qtk_mod_ult_cfg{
...
int qtk_mod_ult_cfg_init(qtk_mod_ult_cfg_t *cfg);
int qtk_mod_ult_cfg_clean(qtk_mod_ult_cfg_t *cfg);
int qtk_mod_ult_cfg_update_local(qtk_mod_ult_cfg_t *cfg,wtk_local_cfg_t *main);
int qtk_mod_ult_cfg_update(qtk_mod_ult_cfg_t *cfg);
#ifdef __cplusplus
};
#endif
#endif
