#ifndef __SDK_MOD_DOUBLE_CFG_H__
#define __SDK_MOD_DOUBLE_CFG_H__
...
typedef struct qtk_mod_double_cfg{
#ifndef __ANDROID__
...
}qtk_mod_double_cfg_t;

int qtk_mod_double_cfg_init(qtk_mod_double_cfg_t *cfg);
int qtk_mod_double_cfg_clean(qtk_mod_double_cfg_t *cfg);
int qtk_mod_double_cfg_update_local(qtk_mod_double_cfg_t *cfg,wtk_local_cfg_t *main);
int qtk_mod_double_cfg_update(qtk_mod_double_cfg_t *cfg);
#ifdef __cplusplus
};
#endif
#endif
